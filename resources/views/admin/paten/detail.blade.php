...
@section('content')
  <div class="content-header">
    ...
    <h3 class="title">Detail Pengajuan Paten: {{ $paten->judul_invensi }} <small class="label bg-red pull-right"><i class="fa fa-close"></i> @if($paten->status='0') Proses @else Diterima @endif</small></h3>
  </div>
  <div class="content">
